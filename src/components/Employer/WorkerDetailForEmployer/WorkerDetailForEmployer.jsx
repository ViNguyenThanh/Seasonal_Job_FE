...
import { ContainerOutlined, EnvironmentOutlined, FolderOpenOutlined, GiftOutlined, IdcardOutlined, MailOutlined, PhoneOutlined, SnippetsOutlined, SolutionOutlined, UserSwitchOutlined } from '@ant-design/icons';
  ...
  return (
    <div className='worker-detail-whole-container'>
      ...
      <div className='worker-detail-for-employer-container'>
        <div className="worker-detail-for-employer-left">
        ...
        <div className="worker-detail-for-employer-right">
